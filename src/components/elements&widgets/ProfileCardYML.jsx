...
const ProfileCardYLM = ({userId,name, age, city}) => {
    
    const navigate = useNavigate();

    return (
        <>
            <div onClick={ () => navigate(`/dashboard/${userId}`)}  className="bg-[#FFF3FA] min-w-[200px]  min-h-auto rounded-[12px] p-4 flex border-[1px] border-[#FFCCEA] hover:bg-[#ffeff8] transition-all cursor-pointer ">
