    ...
    <section id="packages" className="py-16 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 bg-white relative">
      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-['Poppins'] bg-gradient-to-r from-[#FF59B6] to-[#CB3B8B] text-transparent bg-clip-text pb-2 leading-tight">
            Packages & Pricing
          </h2>
          <p className="text-base sm:text-lg lg:text-xl text-[#6D6E6F] mt-4 max-w-2xl mx-auto px-4">
