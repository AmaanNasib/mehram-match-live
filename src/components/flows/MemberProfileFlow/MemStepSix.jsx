        ...
        <div className="form_container_user_creation h-auto bg-white pb-[12px] w-[100vw] ">
          ...
          <div style={{ width: "86.1%", marginLeft: "19.5%", height: "auto" }}>
            ...
            >
              ...
              >
                You're almost there! Please take a moment to review all the details you've provided. This is your chance to ensure everything is accurate and as per your preference before proceeding. If any information needs to be updated, feel free to go back and make the necessary changes. Once you're confident that everything is correct, confirm your profile to move forward in your journey to finding the right partner.
              </p>
              <div
                style={{
                  height: "0.7px",
