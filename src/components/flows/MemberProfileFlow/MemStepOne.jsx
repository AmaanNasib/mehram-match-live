...
const MemStepOne = () => {
  ...
  useEffect(() => {
    ...
    if (userId) {
      ...
      const isBackNavigation =
        location.state?.isNewMember || location.state?.member_id;
      const recentlyCreatedMemberId = localStorage.getItem("member_id");
      const isRecentlyCreated =
        recentlyCreatedMemberId && recentlyCreatedMemberId === String(userId);
      ...
      if (isGoogleSignup) {
        ...
        devLog(
          "Token type:",
          localStorage.getItem("token")?.startsWith("google_")
            ? "Google Signup"
        ...
        const parameter = {
          ...
          setterFunction: (data) => {
            ...
            if (Array.isArray(data) && data.length === 0) {
              console.error(
                "API returned empty array! This might be an API issue."
              );
            ...
            if (Array.isArray(data) && data.length === 0) {
              console.error(
                "API returned empty array - this is likely an API issue"
              );
        ...
        if (!token) {
          ...
          devWarn(
            "Google signup token detected - this might not work with regular API calls"
          );
    ...
    if (apiData && !(isNewMember && clearForm)) {
      ...
      if (apiData.onbehalf) {
        if (apiData.onbehalf === "Brother" || apiData.onbehalf === "Son") {
          ...
          apiData.onbehalf === "Sister" ||
          apiData.onbehalf === "Daughter"
        ) {
          autoGender = "female";
        } else {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      const recentlyCreatedMemberId = localStorage.getItem("member_id");
      const isRecentlyCreated =
        recentlyCreatedMemberId &&
        recentlyCreatedMemberId === String(createdMemberIdRef.current);
      ...
      if (
        ...
        devLog(
          "Skipping cleanup - form submitted or back navigation or recently created member"
        );
        return;
      }
      ...
      if (isNewMemberRef.current && createdMemberIdRef.current) {
        ...
        if (!hasFormData) {
          ...
          fetch(
            `${process.env.REACT_APP_API_URL}/api/user/${memberIdToCleanup}/`,
            {
              method: "DELETE",
              headers: {
  ...
  const handleValidForm = () => {
    ...
    if (!profileData.gender) {
      ...
      if (profileData.on_behalf) {
        if (
          ...
          newErrors.gender =
            "Gender must be Female for Sister/Daughter relationship";
        }
      }
    }
    ...
    devLog(
      "Validation Debug - profession:",
      profileData.profession,
      "Education:",
      profileData.Education,
      "describe_job_business:",
      profileData.describe_job_business
    );
    if (
      (profileData.profession?.toLowerCase() === "other" ||
        profileData.Education?.toLowerCase() === "other") &&
      !profileData.describe_job_business?.trim()
    ) {
      newErrors.describe_job_business =
        "Please describe your education & job/business";
    }
    ...
    if (shouldValidateContact) {
      const phoneRegex =
        /^[+]?[(]?[0-9]{1,4}[)]?[-\s.]?[(]?[0-9]{1,4}[)]?[-\s.]?[0-9]{1,9}$/; // Supports various phone formats
      if (!profileData.contact_number?.trim()) {
        newErrors.contact_number = "Contact Number is required";
      } else if (
        !phoneRegex.test(profileData.contact_number.replace(/\s/g, ""))
      ) {
      ...
      const agentParameter = {
        ...
        setterFunction: (agentData) => {
          const agentContactNumber = Array.isArray(agentData)
            ? agentData.find((a) => a.id == localStorage.getItem("userId"))
                ?.contact_number || agentData[0]?.contact_number
  ...
  const getCities = (country, state) => {
    if (
      ...
      !locationData[country].states[state]
    )
      return [];
  ...
  const Professions = [
    ...
    { value: "Hospitality Professional", label: "Hospitality Professional" },
    {
      ...
      label: "Hotel & Restaurant Professional",
    },
    {
    ...
    {
      value: "Product Manager / Professional",
      label: "Product Manager / Professional",
    },
  ...
  const educationLevels = [
    ...
    {
      value: "Higher Secondary School (12th)",
      label: "Higher Secondary School (12th)",
    },
    {
      value: "ITI (Industrial Training Institute) / Trade School",
      label: "ITI (Industrial Training Institute) / Trade School",
    },
    ...
    {
      value: "Diploma in Computer Applications (DCA)",
      label: "Diploma in Computer Applications (DCA)",
    },
    {
      value: "D.Pharm (Diploma in Pharmacy)",
      label: "D.Pharm (Diploma in Pharmacy)",
    },
    {
      value: "D.Ed (Diploma in Education)",
      label: "D.Ed (Diploma in Education)",
    },
    ...
    {
      value: "Diploma in Interior Design",
      label: "Diploma in Interior Design",
    },
    {
      value: "Diploma in Multimedia/Animation/Design",
      label: "Diploma in Multimedia/Animation/Design",
    },
    {
    ...
    {
      value: "Diploma in Special Education",
      label: "Diploma in Special Education",
    },
    {
      value: "Culinary Arts (Diploma/Degree)",
      label: "Culinary Arts (Diploma/Degree)",
    },
    {
      value: "Event Management (Diploma/MBA Specialization)",
      label: "Event Management (Diploma/MBA Specialization)",
    },
    {
      value: "Digital Marketing (PG Diploma/Certification)",
      label: "Digital Marketing (PG Diploma/Certification)",
    },
    {
      value: "Cybersecurity (Degree/Certification)",
      label: "Cybersecurity (Degree/Certification)",
    },
    {
      value: "Data Science (Degree/Certification)",
      label: "Data Science (Degree/Certification)",
    },
    {
      value: "Artificial Intelligence (Degree/Certification)",
      label: "Artificial Intelligence (Degree/Certification)",
    },
    {
      value: "Animation (Degree/Certification)",
      label: "Animation (Degree/Certification)",
    },
    {
      value: "Game Development (Degree/Certification)",
      label: "Game Development (Degree/Certification)",
    },
    {
      value: "Graphic Design (Degree/Certification)",
      label: "Graphic Design (Degree/Certification)",
    },
    {
      value: "Robotics (Degree/Certification)",
      label: "Robotics (Degree/Certification)",
    },
    {
      value: "Interior Design (Degree/Certification)",
      label: "Interior Design (Degree/Certification)",
    },
    { value: "Nursery/Primary Education", label: "Nursery/Primary Education" },
    {
      value: "Islamic Education (Diploma/Degree)",
      label: "Islamic Education (Diploma/Degree)",
    },
    ...
    {
      value: "BTech / BE (Bachelor of Technology / Engineering)",
      label: "BTech / BE (Bachelor of Technology / Engineering)",
    },
    {
      value: "Software Engineering (B.Tech/BE)",
      label: "Software Engineering (B.Tech/BE)",
    },
    {
      value: "Electronics & Communication Engineering (B.Tech/BE)",
      label: "Electronics & Communication Engineering (B.Tech/BE)",
    },
    {
      value: "Environmental Engineering (B.Tech/BE)",
      label: "Environmental Engineering (B.Tech/BE)",
    },
    {
      value: "Robotics Engineering (B.Tech/BE)",
      label: "Robotics Engineering (B.Tech/BE)",
    },
    ...
    {
      value: "BL / LLB (Bachelor of Law)",
      label: "BL / LLB (Bachelor of Law)",
    },
    {
      value: "BOT (Bachelor of Occupational Therapy)",
      label: "BOT (Bachelor of Occupational Therapy)",
    },
    {
      value: "BOA (Bachelor of Optometry & Ophthalmic Technology)",
      label: "BOA (Bachelor of Optometry & Ophthalmic Technology)",
    },
    ...
    {
      value: "Hospitality Management (BHM/MHM)",
      label: "Hospitality Management (BHM/MHM)",
    },
    {
      value: "journalism",
      label: "Journalism (BA/MA Journalism & Mass Comm.)",
    },
    { value: "film_studies", label: "Film Studies (BA/MA)" },
    {
      value: "Sports Management (BBA/MBA Specialization)",
      label: "Sports Management (BBA/MBA Specialization)",
    },
    { value: "ca", label: "CA (Chartered Accountancy)" },
    { value: "cfa", label: "CFA (Chartered Financial Analyst)" },
    {
      value: "CMA / ICWA (Cost & Management Accounting)",
      label: "CMA / ICWA (Cost & Management Accounting)",
    },
    { value: "Company Secretary (CS)", label: "Company Secretary (CS)" },
    {
      value: "Actuarial Science (Professional Certification)",
      label: "Actuarial Science (Professional Certification)",
    },
    ...
    {
      value: "MD/MS (Doctor of Medicine / Master of Surgery)",
      label: "MD/MS (Doctor of Medicine / Master of Surgery)",
    },
    {
      value: "mch",
      label: "MCh (Master of Chirurgiae – Super Specialty Surgery)",
    },
    { value: "dm", label: "DM (Doctorate of Medicine – Super Specialty)" },
    { value: "phd", label: "PhD (Doctor of Philosophy – All Subjects)" },
    {
      value: "PhD in Islamic Studies / Theology",
      label: "PhD in Islamic Studies / Theology",
    },
    {
    ...
    {
      value: "Ed.D (Doctor of Education)",
      label: "Ed.D (Doctor of Education)",
    },
    { value: "other", label: "Other" },
  ];
                ...
                <form className="space-y-8">
                  ...
                  <div className="space-y-6">
                    <div className="border-b border-gray-200 pb-4">
                      <h3 className="text-lg font-semibold text-gray-900 flex items-center">
                        <span className="bg-[#FFC0E3] text-[#CB3B8B] rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3">
                          1
                        </span>
                        Basic Information
                      </h3>
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-semibold text-gray-700 flex items-center gap-2">
                        ...
                        <div className="group relative tooltip-container">
                          ...
                          <div
                            className={`absolute bottom-full left-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg transition-opacity duration-200 whitespace-nowrap z-50 shadow-lg ${
                              showTooltip === "on_behalf"
                                ? "opacity-100"
                                : "opacity-0 group-hover:opacity-100"
                            }`}
                          >
                            Select who this profile is for. Brother/Son will
                            auto-set gender as Male, Daughter/Sister as Female.
                            For Self/Friend, you'll need to select gender
                            manually.
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleFieldChange("on_behalf", e.target.value)
                        }
                        value={profileData.on_behalf}
                      >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Dropdown
                          options={getCities(
                            profileData.native_country,
                            profileData.native_state
                          )}
                          name="native_city"
                      ...
                      <div className="space-y-2">
                        <label className="block text-sm font-semibold text-gray-700 flex items-center gap-2">
                          ...
                          <div className="group relative tooltip-container">
                            ...
                            <div
                              className={`absolute bottom-full left-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg transition-opacity duration-200 whitespace-nowrap z-50 shadow-lg ${
                                showTooltip === "describe_job_business"
                                  ? "opacity-100"
                                  : "opacity-0 group-hover:opacity-100"
                              }`}
                            >
                              Provide a detailed description of your education
                              and job role or business activities
                              <div className="absolute top-full left-4 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
                            </div>
                          </div>
                        </label>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="₹20,00,000 - ₹50,00,000">
                              ₹20,00,000 - ₹50,00,000
                            </option>
                            <option value="Above ₹50,00,000">
                              Above ₹50,00,000
                            </option>
                      ...
                      <div className="space-y-2">
                        <label className="block text-sm font-semibold text-gray-700 flex items-center gap-2">
                          ...
                          <div className="group relative tooltip-container">
                            ...
                            <div
                              className={`absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg transition-opacity duration-200 whitespace-nowrap z-10 ${
                                showTooltip === "height"
                                  ? "opacity-100"
                                  : "opacity-0 group-hover:opacity-100"
                              }`}
                      ...
                      <div className="space-y-2">
                        <label className="block text-sm font-semibold text-gray-700 flex items-center gap-2">
                          ...
                          <div className="group relative tooltip-container">
                            ...
                            <div
                              className={`absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg transition-opacity duration-200 whitespace-nowrap z-10 ${
                                showTooltip === "type_of_disability"
                                  ? "opacity-100"
                                  : "opacity-0 group-hover:opacity-100"
                              }`}
                            >
                              Please describe the type and nature of your
                              disability
                              <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
                            </div>
                          </div>
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-semibold text-gray-700 flex items-center gap-2">
                        ...
                        <div className="group relative tooltip-container">
                          ...
                          <div
                            className={`absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg transition-opacity duration-200 whitespace-nowrap z-10 ${
                              showTooltip === "about_you"
                                ? "opacity-100"
                                : "opacity-0 group-hover:opacity-100"
                            }`}
                          >
                            Share your values, interests, and what you're
                            looking for
                            <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
                          </div>
                        </div>
                    ...
                    {(() => {
                      ...
                      const shouldShowContactField =
                        (role === "agent" && isNewMember) || editMode;
