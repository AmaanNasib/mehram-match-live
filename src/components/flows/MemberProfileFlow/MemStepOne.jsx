...
userId= username=='memberCreation'?localStorage.getItem("member_id"):userId
  useEffect(() => {
    if (userId) {
  ...
  const naviagteNextStep = () => {
    if (handleValidForm()) {
      ...
      if(username=='memberCreation'){
        mem={  agent_id:localStorage.getItem('userId')||'',
      ...
      const parameters = {
        url: username=='memberCreation'?localStorage.getItem("member_id")?`/api/user/${userId}/`:'/api/user/':`/api/user/${userId}/`,
        payload: {
  ...
  const handleValidForm = () => {
    ...
    if (profileData.disability === 'yes' && !profileData.type_of_disability?.trim()) {
  ...
  return (
    ...
    <div className="absolute right-2 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      ...
      {/* Tooltip text */}
      <div className="absolute z-10 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the Date of Birth field.
      </div>
    </div>
  </div>
  ...
  {formErrors.gender && <p className="text-red-500 text-sm mt-1">{formErrors.gender}</p>}
              ...
              <div style={{ display: "flex", gap: "2rem" }}>
                {/* First Name */}
                <div className="w-[50%] relative">
                  <label htmlFor="maritalStatus" className="block text-sm font-medium text-[#000000]">
                    Marital Status <span style={{ color: "red" }}>*</span>
                  </label>
                  <div className="relative">
                  {/* <Dropdown options={marital_statuses} name="marital_status" /> */}
                  <div className={
    `mt-2 rounded-lg border-1 ${
      formErrors.marital_status ? 
        ...
        : "border-[#898B92] focus-within:border-[#898B92] focus-within:ring-[#898B92]"
                  ...
                  {/* Information icon positioned at right corner of input */}
    <div className="absolute right-4 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-4 w-4 text-red-500 cursor-pointer"
        fill="none"
      ...
      <div className="absolute z-1000 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the Marital Status field.
      </div>
    </div>
  </div>
                  {formErrors.marital_status && <p className="text-red-500 text-sm mt-1">{formErrors.marital_status}</p>}
                </div>
  ...
  <div style={{ display: "flex", width: "100%", gap: "1%" }}>
    ...
    <div className="w-1/2 relative">
      ...
      {formErrors.native_city && <p className="text-red-500 text-sm mt-1">{formErrors.native_city}</p>}
    </div>
    ...
    <div className="w-1/2 relative">
      ...
      {formErrors.native_state && <p className="text-red-500 text-sm mt-1">{formErrors.native_state}</p>}
    </div>
    ...
    <div className="w-1/2 relative">
      ...
      {formErrors.native_country && <p className="text-red-500 text-sm mt-1">{formErrors.native_country}</p>}
    </div>
  </div>
</div>
  ...
  <div className="absolute right-4 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      ...
      {/* Tooltip text */}
      <div className="absolute z-1000 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the Profession field.
      </div>
    </div>
  </div>
                    </div>
                    {formErrors.profession && <p className="text-red-500 text-sm mt-1">{formErrors.profession}</p>}
                  </div>
                </div>
  ...
  <div className="absolute right-4 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      ...
      {/* Tooltip text */}
      <div className="absolute z-1000 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the job/business field.
      </div>
    </div>
  </div>
                  {formErrors.describe_job_business && <p className="text-red-500 text-sm mt-1">{formErrors.describe_job_business}</p>}
                </div>
              </div>
  ...
  <div className="absolute right-4 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      ...
      {/* Tooltip text */}
      <div className="absolute z-1000 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the Disability Status field.
      </div>
    </div>
  </div>
                    {formErrors.disability && <p className="text-red-500 text-sm mt-1">{formErrors.disability}</p>}
                  </div>
                </div>

                {/* Disability Type */}
           { profileData.disability =='yes'&& <div className="w-[50%]">
                  <label
  ...
  <div className="absolute right-4 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      ...
      {/* Tooltip text */}
      <div className="absolute z-1000 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the disability field.
      </div>
    </div>
  </div>
                  {formErrors.type_of_disability && <p className="text-red-500 text-sm mt-1">{formErrors.type_of_disability}</p>}
                </div>}
              </div>
  ...
  <div className="absolute right-4 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      ...
      {/* Tooltip text */}
      <div className="absolute z-1000 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the Income Range field.
      </div>
    </div>
  </div>
                  {formErrors.incomeRange && <p className="text-red-500 text-sm mt-1">{formErrors.incomeRange}</p>}
                </div>
  ...
  <div className="absolute right-4 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      ...
      {/* Tooltip text */}
      <div className="absolute z-1000 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the Personal Values/About You field.
      </div>
    </div>
  </div>
                  {formErrors.about_you && <p className="text-red-500 text-sm mt-1">{formErrors.about_you}</p>}
                </div>
              </div>
  ...
  <div className="absolute right-4 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      ...
      {/* Tooltip text */}
      <div className="absolute z-1000 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the password field.
      </div>
    </div>
  </div>
  ...
  <div className="absolute right-4 top-1/2 transform -translate-y-1/2 group" style={{ zIndex: "1000" }}>
      ...
      {/* Tooltip text */}
      <div className="absolute z-1000 hidden group-hover:block w-64 p-2 text-sm bg-yellow-100 text-yellow-800 rounded shadow-lg left-1/2 transform -translate-x-1/2 mt-1 top-full">
        This is additional information about the confirm_password field.
      </div>
    </div>
  </div>
            ...
            {  username=='memberCreation'&& <>   <div className="w-[50%] relative">
                  <label
                    htmlFor="email"
                    className="block text-sm font-medium text-[#000000]"
                  >
