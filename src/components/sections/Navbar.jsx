    ...
    <header className="bg-white shadow-sm">
      <nav className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <NavLink
          ...
          >
        <div className="logo">
          <img src={logo} style={{ width: "12rem", height: "3rem" }} alt="Mehram Match" className="logo-img" />
        </div>
        </NavLink>
...
//       ".hero-bg",
//       { opacity: 1, y: 300 },
//       { opacity: 1, y: -100, duration: 1.5, ease: "power2.out" }
//     );
//   }, []);
...
//     <header className="">
//       <nav className="container mx-auto px-4 py-3 flex items-center justify-between">
//         <div className="text-2xl font-bold text-[#FBD7ED]">
//           <Link to="/">
//             <svg
//               width="164"
//               height="28"
...
//           <li>
//             <a href="#" className="hover:text-[#e450ab] transition">
//               Home
//             </a>
//           </li>
//           <li>
...
//         <div className="flex space-x-4">
//           {/* Login Button */}
//             <button onClick={()=>setLogin(!login)} className="text-white px-4 py-2 rounded-md bg-gradient-to-r from-[#EE68B3] to-[#FF8DCD] shadow-lg hover:shadow-xl transition-all duration-300">
//               Login
//             </button>
...
//                 className={`absolute right-0 top-12 w-40 bg-white text-[#833E8D] shadow-md rounded-md z-10 ${
//                   isDropdownVisible ? "visible-dropdown" : "hidden-dropdown"
//                 }`}
//               >
//                 <Link
//                   to="/agent"
//                   className="block px-4 py-2 hover:bg-[#FBD7ED] hover:text-[#9E286A] transition"
//                 >
//                   Agent
//                 </Link>
